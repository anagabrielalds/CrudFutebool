...
namespace futebool.Migrations
{
    ...
    [Migration("20210304161041_criacaoBd")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("futebool.Models.AcontecimentosDoJogo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("futebool.Models.Campo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("futebool.Models.Jogador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasAlternateKey("Nome", "NumeroCamisa");
            ...
            modelBuilder.Entity("futebool.Models.Jogo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("futebool.Models.Tecnico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("futebool.Models.Times", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("futebool.Models.AcontecimentosDoJogo", b =>
                {
                    b.HasOne("futebool.Models.Jogador", "Jogador")
                        .WithMany()
                        .HasForeignKey("JogadorId");

                    b.HasOne("futebool.Models.Jogo", "Jogo")
                        .WithMany()
                        .HasForeignKey("JogoId");

                    b.HasOne("futebool.Models.Times", "Time")
                        .WithMany()
            ...
            modelBuilder.Entity("futebool.Models.Jogo", b =>
                {
                    b.HasOne("futebool.Models.Campo", "Campo")
                        .WithMany()
                        .HasForeignKey("CampoId");

                    b.HasOne("futebool.Models.Times", "TimeCasa")
                        .WithMany()
                        .HasForeignKey("TimeCasaId");

                    b.HasOne("futebool.Models.Times", "TimeVisitante")
                        .WithMany()
            ...
            modelBuilder.Entity("futebool.Models.Times", b =>
                {
                    ...
                    b.HasOne("futebool.Models.Tecnico", "Tecnico")
                        .WithMany()
