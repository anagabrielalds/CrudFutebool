...
{
    public partial class FutebolCntextChave : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TimeCasaId = table.Column<int>(type: "int", nullable: true),
                    TimeVisitanteId = table.Column<int>(type: "int", nullable: true),
                    CampoId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jogadores_Nome_NumeroCamisa",
                table: "Jogadores",
                columns: new[] { "Nome", "NumeroCamisa" },
                unique: true,
